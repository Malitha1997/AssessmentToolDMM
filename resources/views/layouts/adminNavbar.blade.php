                ...
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    <div class="sidebar-brand-text mx-3" >
                        <ul class="navbar-nav text-light" id="accordionSidebar-1" style="margin-left: -15px;">
                            <li class="nav-item" data-aos="fade-right" data-aos-duration="500"><a class="nav-link" href="index.html"><img src="{{ asset('img/Mask group(1).png') }}"><span style="color: #5f2b84;font-family: Poppins, sans-serif;font-size: 16px;margin-left: 10px;">Dashboard</span></a></li>
                            <li class="nav-item" data-aos="fade-right" data-aos-duration="500" data-aos-delay="50"><a class="nav-link" href="index.html"><img src="{{ asset('img/Mask group(2).png') }}"><span style="color: #5f2b84;font-family: Poppins, sans-serif;font-size: 16px;margin-left: 10px;">Organization</span></a></li>
                            <li class="nav-item" data-aos="fade-right" data-aos-duration="500" data-aos-delay="100"><a class="nav-link" href="index.html"><img src="{{ asset('img/Mask group(3).png') }}"><span style="color: #5f2b84;font-family: Poppins, sans-serif;font-size: 16px;margin-left: 10px;">Assessment</span></a></li>
                            <li class="nav-item" data-aos="fade-right" data-aos-duration="500" data-aos-delay="150"><a class="nav-link" href="index.html"><img src="{{ asset('img/Mask group(4).png') }}"><span style="color: #5f2b84;font-family: Poppins, sans-serif;font-size: 16px;margin-left: 10px;">Create User</span></a></li>
                            <li class="nav-item" data-aos="fade-right" data-aos-duration="500" data-aos-delay="200"><a class="nav-link" href="index.html"><img src="{{ asset('img/Mask group(1).png') }}"><span style="color: #5f2b84;font-family: Poppins, sans-serif;font-size: 16px;margin-left: 10px;">Settings</span></a></li>
                        </ul>
                    </div>
                </a>
