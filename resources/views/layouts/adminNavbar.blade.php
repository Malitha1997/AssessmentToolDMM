                ...
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    <div class="sidebar-brand-text mx-3" >
                        <ul class="navbar-nav text-light" id="accordionSidebar-1" style="margin-left: -15px;">
                            ...
                            <li class="nav-item dropdown" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="100">
                                <!-- <a class="nav-link" href="{{ route('competancyDashboard') }}"><img src="{{ asset('img/Mask group(3).png') }}"><span style="color: #5f2b84;font-family: Poppins, sans-serif;font-size: 16px;margin-left: 10px;">Assessment</span></a> -->
                                <button class="btn btn-white dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" style="margin-left:-10px">
                                    <i class="fa fa-lg fa-file-text" aria-hidden="true" style="color:#5f2b84"></i><span style="color: #5f2b84;font-family: Poppins, sans-serif;font-size: 16px;margin-left: 10px;">Assessments</span>
                                </button>
