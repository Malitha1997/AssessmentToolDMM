...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('cssfile/Data-Table-styles.css') }}">
    <link rel="stylesheet" href="{{ asset('cssfile/Data-Table.css') }}">
                ...
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    <div class="sidebar-brand-text mx-3" >
                        <ul class="navbar-nav text-light" id="accordionSidebar-1" style="margin-left: -15px;">
                            <li class="nav-item" data-aos="fade-right" data-aos-duration="1000"><a class="nav-link" href="{{route('dashboard')}}"><img src="{{ asset('img/Mask group(1).png') }}"><span style="color: #5f2b84;font-family: Poppins, sans-serif;font-size: 16px;margin-left: 10px;">Dashboard</span></a></li>
                            <!-- <li class="nav-item" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="50"><a class="nav-link" href=""><img src="{{ asset('img/Mask group(2).png') }}"><span style="color: #5f2b84;font-family: Poppins, sans-serif;font-size: 16px;margin-left: 10px;">Organizations</span></a></li> -->
                            <li class="nav-item" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="100"><a class="nav-link" href="{{route('layerDashboard')}}"><img src="{{ asset('img/Mask group(3).png') }}"><span style="color: #5f2b84;font-family: Poppins, sans-serif;font-size: 16px;margin-left: 10px;">Assessment</span></a></li>
