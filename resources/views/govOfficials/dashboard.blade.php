...
@section('content')
    ...
    <!-- <div class="container" style="margin-top: 40px;font-family:poppins" data-aos="fade-down" data-aos-duration="1000">
        <div class="row" style="height: 479px;">
            ...
            <div class="col-md-6" style="font-family:poppins;margin-left: 20px;height: 200px;width: 550px;border-radius: 10px;border-style: solid;border-color: var(--bs-dark-border-subtle);">
                ...
                <div class="row" style="width: 550px;margin-top: 20px;border-style: solid;border-color: var(--bs-dark-border-subtle);border-radius: 10px;height: 225px;">
                    
                </div>
            </div>
        </div>
    </div> -->
    <div class="row" data-aos="fade-down" data-aos-duration="1000" style="font-family:poppins;height: 500px;margin-top: 10px;border-style: solid;border-color: var(--bs-dark-border-subtle);border-radius: 10px;">
    ...
    <div style="font-family:poppins;height: 1300px;margin-top: 20px;border-style: solid;border-color: var(--bs-dark-border-subtle);border-radius:10px">
        <div class="container" style="margin-top: 40px;">
            <div class="row">
                ...
                <div class="col-md-6 col-xxl-6" style="width: 570px;">
                    <div class="row">
                        <div class="col">
                        <form class="form-control" method="GET" action="" style="border-width:0px;height:70px">
                    <div class="col">
                                ...
                                <table class="table">
                                    ...
                                    @foreach ($govofficials as $govofficial)
                                        <tr>
                                            ...
                                            <td>{{$govofficial->employment_layer}}</td>
