        ...
        <div class="container" data-aos="fade-down" data-aos-duration="1000"  style="width: 80%;margin-top: 5%;margin-bottom:5%">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-sm-6" style="background: linear-gradient(to top right, #660066 56%, #FF6699 100%);">
                    ...
                    <div class="container" style="background-color:#fff;border-radius: 10px;height:70%;width:85%;margin-top:10%;height:80%">  
                        <div class="row">
                            <h4 id="h3" style="text-align: center;font-family: Poppins, sans-serif;margin-top: 10%;color: #5f2b84;font-weight:bold">Don't have an account?</h4>
                        </div>
                        <div class="row">
                ...
                <div class="col-lg-6 col-sm-6" style="height:60%;border-color: rgb(0,10,255);border-style: solid;border-color: #5f2b84;">
                    <h3 id="h3" style="color: #f01f75;text-align: center;font-family: Poppins, sans-serif;margin-top: 5%;font-weight:bold">Login Your Account</h3>
