    ...
    <style>
        ...
        <div style="border-style: solid;border-color: #000000; width:700px;height:1450px"
            <div class="container" style="width: 535px;height: 782px;text-align:center">
                ...
                <div class="row" style="margin-top: 50px;">
                    <div class="col" style="text-align: center;"><span style="font-size: 40px;color: #1c2c84;font-family: Poppins, sans-serif;font-weight: bold;">Preliminary Assessment<br>Report of<br>{{ $govorganizationdetail->govorganizationname->gov_org_name }}</span></div>
                </div>
        ...
        <div class="container" style="width: 2400px; height: 782px; ">
            ...
            <div class="row" style="margin-top:50px;text-align: center;border-style: solid;border-width: 1px;border-color: #ff0000;width: 500px;margin-left: 25%">
                <div class="col" ><span style="font-family: Poppins, sans-serif;font-size: 16px;">Your Organization gained<br><b>{{ $govorganizationdetail->percentage->overall }}%</b> for the Preliminary Assessment.</span></div>
            </div>
            <div class="row" style="text-align: center;margin-top:20px">
                ...
                <div class="col">
                    <ul style="font-family: Poppins, sans-serif;text-align: left;margin-top: 200px">You gained,
                        <li style="font-family: Poppins, sans-serif;margin-left: 20px"> {{ $govorganizationdetail->percentage->technology }}% for Technology & Data dimension.</li>
                        <li style="font-family: Poppins, sans-serif;margin-left: 20px"> {{ $govorganizationdetail->percentage->customer }}% for Customer dimension.</li>
                        <li style="font-family: Poppins, sans-serif;margin-left: 20px"> {{ $govorganizationdetail->percentage->operation }}% for Operation dimension.</li>
                        <li style="font-family: Poppins, sans-serif;margin-left: 20px"> {{ $govorganizationdetail->percentage->strategy }}% for Strategy dimension.</li>
                        <li style="font-family: Poppins, sans-serif;margin-left: 20px"> {{ $govorganizationdetail->percentage->culture }}% for Organization & Culture dimension.</li>
                    </ul>
                </div>
            </div>
