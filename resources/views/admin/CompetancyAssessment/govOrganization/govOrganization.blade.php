...
@section('content')
<span style="margin-top: 180px;color: #1F2471;font-size: 24px;font-weight: bold;margin-left: 400px;font-family:poppins">{{ $govofficial->govorganizationname->gov_org_name }}</span>
<div class="container" style="margin-top: 50px;font-family:poppins">
    <div class="row" style="height: 479px;">
        <div class="col-md-6" style="height: 420px;border-radius: 10px;border-style: solid;border-color: var(--bs-dark-border-subtle);"><span style="color: #F01F75;">General Information</span>
            <div class="row">
                <div class="col" style="margin-top: 30px;"><span style="color: var(--bs-emphasis-color);">User Name</span><input type="text" style="margin-left: 150px;width: 300px;border-style: solid;border-color: var(--bs-secondary-border-subtle);border-radius: 5px;" value="{{ $govofficial->govorganizationname->govorganizationdetail->user->username}}" readonly></div>
            </div>
            <div class="row">
                <div class="col" style="margin-top: 30px;"><span style="color: var(--bs-emphasis-color);">Organization Name</span><input type="text" style="margin-left: 84px;width: 300px;border-style: solid;border-color: var(--bs-secondary-border-subtle);border-radius: 5px;" value="{{ $govofficial->govorganizationname->gov_org_name }}" readonly></div>
            </div>
            <div class="row">
...
<div class="row" style="background: #1F2471;text-align: center;font-family:poppins">
...
<div style="height: 500px;margin-top: 20px;border-style: solid;border-color: var(--bs-emphasis-color);font-family:poppins">
            ...
            <div class="col-md-6" style="text-align: center;">
                        ...
                        <div class="row" style="width: 257px;height: 85px;margin-top: 50px;margin-bottom: 50px;margin-left: 150px;background: var(--bs-body-bg);border-radius: 10px;box-shadow: 0px 0px 12px 1px rgb(37,30,30);">
                            <div class="col" style="border-radius: 10px;"><span style="color: var(--bs-emphasis-color);margin-top: 10px;">Number of Responses</span>
                                <div class="row" style="font-weight: bold;">
                                    <div class="col"><span style="color: var(--bs-emphasis-color);font-size: 24px;">100</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row" style="width: 257px;height: 85px;margin-left: 150px;background: var(--bs-body-bg);border-radius: 10px;box-shadow: 0px 0px 12px 1px rgb(37,30,30);">
                    <div class="col"><span style="color: var(--bs-emphasis-color);margin-top: 10px;">Inprogress</span>
                        <div class="row" style="font-weight: bold;">
                            <div class="col"><span style="color: var(--bs-emphasis-color);font-size: 24px;">34</span></div>
                        </div>
                    </div>
                </div>
            </div>
