    ...
    <section data-aos="fade-down" data-aos-duration="1000" >
        <div class="container container-expand-sm" data-aos="fade-down" data-aos-duration="1000" style="margin-top: 150px;margin-bottom: 20px;border-radius: 10px;border: 4px solid #5f2b84;">
            <div class="row" style="width:1377px;height:185px">
                ...
                <div class="col" style="margin-top:60px;width:327px"><a class="btn btn-primary" href="" data-aos="fade-down" type="button" style="width: 156.09px;height: 51px;font-size: 18px;font-family: Poppins, sans-serif;border-width: 0px;background: url(&quot;{{ asset('img/Screenshot (561) 10.png') }}&quot;);margin-right: 80px;">Continue</a></div></div>
            </div>
        </div>
        <div class="container container-expand-sm" data-aos="fade-down" data-aos-duration="1000" style="margin-top: 50px;margin-bottom: 20px;border-radius: 10px;border: 4px solid #5f2b84;">
            <div class="row">
                <div class="col" style="width:1377px;height:168px">
                    <div class="row" style="margin-top:50px;width:700px"><span style="font-family: Poppins, sans-serif;color: #000000;font-size:20px">You are eligible for Preliminary assessment.  Asses the Digital Maturity Level of organization. </span></div>
                </div>
                ...
                <div class="col" style="width:150px">
                    <div class="row" style="margin-top:50px;"><button class="btn btn-primary" href="" data-aos="fade-down" type="button" style="width: 266px;height: 55px;background: url(&quot;{{ asset('img/Screenshot (561) 5.png') }}&quot;);border-width: 0px;font-family: Poppins, sans-serif;font-size: 20px;" disabled>Deep Assessment</button></div>
                </div>
            </div>
        </div>
        <div class="container container-expand-sm" data-aos="fade-down" data-aos-duration="1000" style="margin-top: 50px;margin-bottom: 20px;border-radius: 10px;border: 4px solid #5f2b84;">
