...
<body id="body" style="width: auto;border-color: rgb(46,127,208);color: rgb(255,255,255);">
    <section data-aos="fade-down" data-aos-duration="1000">
        @if(Auth::user()->govorganizationdetail == NULL)
                ...
                <div class="row">
                    <div class="col" id="col" style="width:1377px;height:168px">
                        <div class="row" style="margin-top:50px;width:700px">
                            <span style="font-family: Poppins, sans-serif;color: #000000;font-size:20px">Kindly complete the registration process prior to taking the assessment.</span>
                        </div>
                    </div> 
                    <div class="col" style="width:150px">
                        <div class="row" style="margin-top:50px;">
                            <a class="btn btn-primary" id="layerButton" href="{{route('signup')}}" type="button" style="margin-left:30%;text-align:center;width:40%;background: linear-gradient(to bottom right, #F44567 0%, #F97B5F 49%);border-width: 0px;font-family: Poppins, sans-serif;"><h5>Register</h5></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col" style="width: auto;margin-top: 20px">
                        ...
                        <div class="row" style="margin-bottom: 25px;">
                            ...
                            <div class="col" style="text-align: left"><input class="" type="text" data-aos="fade-down" style="color:#FF0000;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->govorganizationname->gov_org_name ?? 'No data'}}" readonly></div>
                        </div>
                        <div class="row" style="margin-bottom: 25px;">
                            <div class="col" style="margin-top: 10px;">
                            ...
                            <div class="col" style="text-align: left;"><input class="" type="text" data-aos="fade-down" style="color:#FF0000;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->relatedMinistry->related_ministry ?? 'No data'}}" readonly></div>
                        </div>
                        <div class="row" style="margin-bottom: 25px;">
                            <div class="col" style="margin-top: 10px;">
                            ...
                            <div class="col" style="width: 350px;height: 34px;margin-top: 0px;text-align: left;"><input  class="" type="text" data-aos="fade-down" style="color:#FF0000;width:250px;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->organizationCategory->org_category ?? 'No data'}}"  readonly></div>
                        </div>
                        <div class="row" style="margin-bottom: 25px;">
                            <div class="col" style="margin-top: 10px;">
                            ...
                            <div class="col" style="border: 0px;font-family: Poppins;text-align: left"><input class="" type="text" data-aos="fade-down" style="color:#FF0000;width:550px;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->types_of_service ?? 'No data'}}" readonly></div>
                        </div>
                        <div class="row" style="margin-bottom: 25px;">
                            <div class="col" style="margin-top: 10px;">
                            ...
                            <div class="col" style="border: 0px;font-family: Poppins;text-align: left"><input class="" type="text" data-aos="fade-down" style="color:#FF0000;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->number_of_employee ?? 'No data'}}" readonly></div>
                        </div>
                        <div class="row" data-aos="fade-down" style="margin-bottom: 25px;">
                            ...
                            <div class="col" style="border: 0px;font-family: Poppins;text-align: left"><input class="" type="text" style="color:#FF0000;width:550px;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->districts_of_operations ?? 'No data'}}" readonly></div>
                        </div>
                        <div class="row" style="margin-top: 30px;margin-bottom: 25px;">
                        ...
                        <div class="row" style="margin-bottom: 25px;">
                            ...
                            <div class="col" style="border: 0px;font-family: Poppins;text-align: left"><input class="" type="text" data-aos="fade-down" style="color:#FF0000;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->phone_number ?? 'No data'}}" readonly></div>
                        </div>
                        <div class="row" style="margin-bottom: 25px;">
                            <div class="col" style="margin-top: 10px;">
                            ...
                            <div class="col" style="border: 0px;font-family: Poppins;text-align: left"><input class="" type="text" data-aos="fade-down" style="color:#FF0000;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->gov_org_email ?? 'No data'}}" readonly></div>
                        </div>
                        <div class="row" style="margin-top: 30px;margin-bottom: 25px;">
                        ...
                        <div class="row" style="margin-bottom: 25px;">
                            ...
                            <div class="col" style="border: 0px;font-family: Poppins;text-align: left"><input class="" type="text" data-aos="fade-down" style="color:#FF0000;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->name_of_the_head ?? 'No data'}}" readonly></div>
                        </div>
                        <div class="row" style="margin-bottom: 25px;">
                            <div class="col" style="margin-top: 10px;">
                            ...
                            <div class="col" style="border: 0px;font-family: Poppins;text-align: left"><input class="" type="text" data-aos="fade-down" style="color:#FF0000;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->designation ?? 'No data'}}" readonly></div>
                        </div>
                        <div class="row" style="margin-bottom: 25px;">
                            <div class="col" style="margin-top: 10px;">
                            ...
                            <div class="col" style="border: 0px;font-family: Poppins;text-align: left"><input class="" type="text" data-aos="fade-down" style="color:#FF0000;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->head_email ?? 'No data'}}" readonly></div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 25px;">
                            ...
                            <div class="col" style="border: 0px;font-family: Poppins;text-align: left"><input class="" type="text" data-aos="fade-down" style="color:#FF0000;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->cdio_name ?? 'No data'}}" readonly></div>
                        </div>
                        <div class="row" style="margin-bottom: 25px;">
                            <div class="col" style="margin-top: 10px;">
                            ...
                            <div class="col" style="border: 0px;font-family: Poppins;text-align: left"><input class="" type="text" data-aos="fade-down" style="color:#FF0000;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->cdio_email ?? 'No data'}}" readonly></div>
                        </div>
                        <div class="row" style="margin-bottom: 25px;">
                            <div class="col" style="margin-top: 10px;">
                            ...
                            <div class="col" style="border: 0px;font-family: Poppins;text-align: left"><input class="" type="text" data-aos="fade-down" style="color:#FF0000;border: 0px;font-family: Poppins;text-align: left;font-size: 20px" value="{{Auth::user()->govorganizationdetail->cdio_contact_no ?? 'No data'}}" readonly></div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 25px;">
                            ...
                            <div class="col" style="border: 0px;font-family: Poppins;text-align: left"><input class="" type="text" data-aos="fade-down" style="color:#FF0000;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->dtu_type ?? 'No data'}}" readonly></div>
                        </div>
                        <div class="row" style="margin-bottom: 25px;">
                            <div class="col" style="margin-top: 10px;">
                            ...
                            <div class="col" style="border: 0px;font-family: Poppins;text-align: left"><input class="" type="text" data-aos="fade-down" style="color:#FF0000;border: 0px;font-family: Poppins;text-align: left;font-size: 20px;" value="{{Auth::user()->govorganizationdetail->number_of_employees_dtu ?? 'No data'}}" readonly></div>
                        </div>
