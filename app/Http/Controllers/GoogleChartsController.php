...
class GoogleChartsController extends Controller
{
    ...
    public function adminTechnologyChart(string $id)
    {//
        $user=User::find($id);
        $g_user=$user->govorganizationdetail;
        $technology = $user->govorganizationdetail->technology;
    ...
    // Pass the organized data to the view
    return view('admin.PreliminaryResults.technologyresults', compact('result','g_user'));

    }

    public function adminCustomerChart(string $id)
    {//
        // Retrieve the customer data for the authenticated user
        $user=User::find($id);
        $g_user=$user->govorganizationdetail;
        $customer = $user->govorganizationdetail->customer;
    ...
    // Pass the organized data to the view
    return view('admin.PreliminaryResults.customerresults', compact('result','g_user'));

    }

    public function adminOperationChart(string $id)
    {//
        $user=User::find($id);
        $g_user=$user->govorganizationdetail;
        $operation = $user->govorganizationdetail->operation;
        ...
        // Pass the organized data to the view
        return view('admin.PreliminaryResults.operationresults', compact('result','g_user'));

    }

    public function adminStrategyChart(string $id)
    {//
        $user=User::find($id);
        $g_user=$user->govorganizationdetail;
        $strategy = $user->govorganizationdetail->strategy;
        ...
        // Pass the organized data to the view
        return view('admin.PreliminaryResults.strategyresults', compact('result','g_user'));

    }

    public function adminCultureChart(string $id)
    {//
        $user=User::find($id);
        $g_user=$user->govorganizationdetail;
        $culture = $user->govorganizationdetail->culture;
        ...
        // Pass the organized data to the view
        return view('admin.PreliminaryResults.cultureresults', compact('result','g_user'));
