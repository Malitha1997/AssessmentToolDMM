...

{
     ...
     */
     ...
     public function adminGeneratePDF(string $id){
        $user=User::find($id);
        $govorganizationdetail=$user->govorganizationdetail;
        //$govorganizationname = $govorganizationdetail->govorganizationname->gov_org_name;

        // Fetch data for the radar chart
        $labels = ["Customer", "Strategy", "Technology & data", "Operation", "Organization & culture"];

        // Assuming the authenticated user has a "govorganizationdetail" and it's related to a "percentage"
        $percentage = $govorganizationdetail->percentage;
        ...
        $technology = $govorganizationdetail->technology;
        ...
        // Retrieve the customer data for the authenticated user
        $customer = $govorganizationdetail->customer;
        ...
        // Retrieve the operation data for the authenticated user
        $operation = $govorganizationdetail->operation;
        ...
        $operation = [
         ...
         // Organize the strategy data for Google Charts
        $strategy = $govorganizationdetail->strategy;
        ...
        // Get the authenticated user's culture data
        $culture = $govorganizationdetail->culture;
